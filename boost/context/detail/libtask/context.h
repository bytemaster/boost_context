...
#	if defined(__i386__)
#		include <boost/context/detail/libtask/386-ucontext.h>
#	elif defined(__x86_64__)
#		include <boost/context/detail/libtask/amd64-ucontext.h>
#	else
#		include <boost/context/detail/libtask/power-ucontext.h>
#	endif	
#endif
...
#if defined(__mips__)
#include <boost/context/detail/libtask/mips-ucontext.h>
int getmcontext(mcontext_t*);
void setmcontext(const mcontext_t*);
#define	setcontext(u)	setmcontext(&(u)->uc_mcontext)
#define	getcontext(u)	getmcontext(&(u)->uc_mcontext)
